...
import { mockTickets, mockUsers } from '../data/mock-data';
...
export default function MobileClient() {
  ...
  const currentUser = mockUsers[0]; // John Client
  const userTickets = mockTickets.filter(t => t.createdBy.id === currentUser.id);
