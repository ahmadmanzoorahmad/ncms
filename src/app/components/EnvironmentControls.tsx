...
export function EnvironmentControls() {
  const { environment, setEnvironment, currentUser, setCurrentUser, canSwitchRoles } = useApp();

  const groupedUsers = {
    'Citizens': mockUsers.filter(u => u.role === 'Citizen'),
    'Call Center': mockUsers.filter(u => u.role === 'Call Center Officer'),
    'Support Agents': mockUsers.filter(u => u.role === 'Support Agent'),
    'Field Engineers': mockUsers.filter(u => u.role === 'Field Engineer'),
    'Supervisors': mockUsers.filter(u => u.role === 'Supervisor'),
    'Department Heads': mockUsers.filter(u => u.role === 'Department Head'),
    'Executive': mockUsers.filter(u => u.role === 'Executive'),
    'Auditors': mockUsers.filter(u => u.role === 'Auditor'),
    'System Admin': mockUsers.filter(u => u.role === 'System Admin'),
  };
